...
export const metadata: Metadata = {
  ...
  description: 'Convert your bathtub to a walk-in shower anywhere in Texas. Quick 1-day installation, increased space, modern design. Serving Austin, Houston, Dallas, San Antonio, and more. Call 512-706-9577.',
