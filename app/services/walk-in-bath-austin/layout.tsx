...
export const metadata: Metadata = {
  ...
  description: 'Premier walk-in bath installations across Texas. Safe, accessible bathing solutions for seniors and mobility concerns throughout Austin, Houston, Dallas, San Antonio, and more. ADA compliant. Call 512-706-9577.',
