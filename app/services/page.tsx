            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  ...
                  onClick={() => trackPhoneClick('512-706-9577', 'Services Hero')}
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  onClick={() => trackCTAClick('Submit Request', 'Services Hero Form', '/thank-you')}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <a
                    href="tel:512-706-9577"
                    onClick={() => trackPhoneClick('512-706-9577', 'Services - Tile Installation')}
      ...
      <section className="relative py-24 bg-gradient-to-b from-black to-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:512-706-9577"
              onClick={() => trackPhoneClick('512-706-9577', 'Services Final CTA')}
