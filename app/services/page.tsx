        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-200 bg-white shadow-sm">
              ...
              <span className="text-xs font-medium text-blue-600 uppercase tracking-widest">Our Services</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-light text-gray-900 tracking-tight">
              Bathroom & Flooring
              <br />
              <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-700 bg-clip-text text-transparent">Remodeling Services</span>
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-light text-gray-900">
                  Bathroom Remodeling <span className="text-blue-600">Austin</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-blue-600 rounded-lg font-medium text-blue-600 hover:bg-blue-50 transition-all"
                  >
                    Get Free Quote
                  </Link>
                </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-200 bg-cyan-50">
                  <span className="text-xs font-medium text-cyan-600 uppercase tracking-widest">Safety & Comfort</span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-light text-gray-900">
                  Walk-in Bath <span className="text-cyan-600">Austin</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <a
                    href="tel:512-706-9577"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg font-medium text-white hover:shadow-lg hover:shadow-cyan-500/40 transition-all"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-cyan-600 rounded-lg font-medium text-cyan-600 hover:bg-cyan-50 transition-all"
                  >
                    Learn More
                  </Link>
                </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-light text-gray-900">
                  Shower Remodel <span className="text-blue-600">Austin</span>
                </h2>
