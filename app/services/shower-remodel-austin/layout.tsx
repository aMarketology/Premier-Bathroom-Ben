...
export const metadata: Metadata = {
  ...
  description: 'Expert shower remodeling across Texas. Custom walk-in showers, frameless glass, rainfall heads, and spa-inspired designs. Serving Austin, Houston, Dallas, San Antonio, and more. Call 512-706-9577.',
