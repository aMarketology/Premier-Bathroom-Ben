...
export async function POST(request: NextRequest) {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              ${serviceLabel ? `<div class="field"><div class="field-label">Service Requested</div><div class="field-value">${serviceLabel}</div></div>` : ''}
    ...
    const { error } = await resend.emails.send({
      ...
      replyTo: email,
      subject: `New Contact Form - Tile Pros Austin - ${name}`,
      html: htmlContent,
    })
