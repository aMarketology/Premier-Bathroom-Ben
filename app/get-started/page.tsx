    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <form onSubmit={handleHeroSubmit} className="space-y-4">
                  ...
                  >
                    {heroLoading ? 'SUBMITTING...' : 'GET FREE QUOTE â†’'}
                  </button>
                </form>
              </motion.div>
            </div>
      ...
      <section className="bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 text-white py-6 overflow-hidden border-y-4 border-accent-gold">
        <div className="whitespace-nowrap animate-scroll">
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… SERVING AUSTIN FOR 15+ YEARS â˜…</span>
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… LICENSED & INSURED â˜…</span>
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… 100% SATISFACTION GUARANTEED â˜…</span>
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… SERVING AUSTIN FOR 15+ YEARS â˜…</span>
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… LICENSED & INSURED â˜…</span>
          <span className="inline-block px-8 text-lg font-bold uppercase tracking-widest">â˜… 100% SATISFACTION GUARANTEED â˜…</span>
        </div>
