        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Remodeling your bathroom shouldn't be complicated. At Tile Pros Austin, our process is straightforward, from your first call through final inspection. Quick turnaround, complete transparency, and no shortcuts.
            </p>
          </div>
      ...
      <section className="relative py-32 bg-gradient-to-b from-black to-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
            Take the first step in transforming your space. Contact Tile Pros Austin today for a free consultation and quote. Serving Austin, Houston, Dallas, San Antonio, and all of Texas.
          </p>
