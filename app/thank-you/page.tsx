...
export default function ThankYou() {
  ...
  // Fire Google Ads + GA4 conversion on page load
  useEffect(() => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      const gtag = (window as any).gtag
      // Google Ads conversion — TODO: replace with your actual conversion label
      ...
      gtag('event', 'generate_lead', {
        ...
        form_location: document.referrer || '/thank-you',
      })
    }
  }, [])
